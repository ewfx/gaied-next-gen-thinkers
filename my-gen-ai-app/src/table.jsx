...
const rows = [
  createData(1, "Test Subject1", "Service Request1", 0.9, "Test Reasoning1"),
  createData(2, "Test Subject2", "Service Request2", 0.8, "Test Reasoning4"),
  createData(3, "Test Subject3", "Service Request3", 0.7, "Test Reasoning3"),
  createData(4, "Test Subject4", "Service Request4", 0.5, "Test Reasoning2"),
];
...
export default function EnhancedTable({
  ...
  const [orderBy, setOrderBy] = React.useState("confidance");
