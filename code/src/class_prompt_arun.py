...
def classify_email(subject, body, attachment_text):
    ...
    # formattedPrompt = full_prompt.format(
    #     subject=subject,
    #     body=body,
    #     attachment_text=attachment_text,
    #     classification_data=classification_data,
    ...
    # classifications = chat.send_message(r""" 
    ...
    # extraInformation = chat.send_message(r"""Please also provide all of the extra  financial information from the email content provided above:
    #     **Output JSON Format:**
    #         {{
    #             "extracted_information": {{
    #                 "amount": "1500.00",
    ...
    # extraInformationCleaned = chat.send_message(r"""
